  ...
  return (
    <div className='mx-auto max-w-[1280px]'>
        ...
        <div className='max-w-[1280px] md:h-fit text-black px-6 py-8 mx-auto flex flex-col md:flex-row justify-center mb-5 items-center gap-y-5 md:justify-between'>
          ...
          <div className='order-1 md:order-2 text-black flex flex-col justify-center bg-white md:min-w-[370px] md:pb-16 p-5 border border-gray-600 rounded-xl shadow-lg'>
