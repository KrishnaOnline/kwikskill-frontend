  ...
  return (
    <div className='mx-auto max-w-[1280px]'>
        ...
        <div className='max-w-[1280px] md:h-fit text-black px-6 py-8 mx-auto flex flex-col md:flex-row justify-center mb-5 items-center gap-y-5 md:justify-between'>
          <div className='flex flex-col gap-3 order-2 md:order-1 md:mt-9 -translate-y-10 max-md:hidden'>
          ...
          <div className='order-1 md:order-2 text-black flex flex-col justify-center bg-white md:max-w-[380px] md:pb-16 p-5 border border-gray-600 rounded-xl shadow-lg'>
